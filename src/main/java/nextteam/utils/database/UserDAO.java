...
public class UserDAO extends SQLDatabase {
    ...
    public ArrayList<User> getListUsers() {
        ...
        try {
            while (rs.next()) {
                list.add(new User(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12), rs.getString(13), rs.getString(14), rs.getString(15), rs.getString(16), rs.getDate(17), rs.getDate(18)));
            }
    ...
    public User getListUserById(User t) {
        ...
        try {
            ...
            if (rs.next()) {
                ketQua = new User(rs.getInt(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6), rs.getString(7), rs.getString(8), rs.getString(9), rs.getString(10), rs.getString(11), rs.getString(12), rs.getString(13), rs.getString(14), rs.getString(15), rs.getString(16), rs.getDate(17), rs.getDate(18));
            }
    ...
    public int delete(String id){
     ...
     public int update( User t) {
         int ketQua = 0;
            ketQua = executeUpdatePreparedStatement(
                    "UPDATE users  SET  email=?, avatarUrl=?, firstname=?, lastname=?, studentCode=?, phoneNumber=?,major=?,academicYear=?,gender=?,dob=?,homeTown=?,facebookUrl=?,linkedInUrl=? WHERE id=?", 
                    t.getEmail(),
                    t.getAvatarURL(),
                    t.getFirstname(),
                    t.getLastname(),
