<%-- Document : index.jsp Created on : 1 thg 7, 2023, 09:01:57 Author : phangiabao --%> <%@page contentType="text/html"
pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		<% String error = request.getAttribute("error") + ""; if (error.equals("null")) { error = "Sign in with Google is
		only available with Student Email. Not for staff!"; } %>
		<div class="container">
			<div class="row">
